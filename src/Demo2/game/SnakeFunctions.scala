...
class SnakeFunctions extends JFXApp {
  ...
  this.stage = new PrimaryStage {
    ...
    scene = new Scene(windowWidth, windowHeight) {
      content = List(sceneGraphics)
        // add an EventHandler[Keyvent] to control player movement
...
// cd IdeaProject/Hello_World
// src/electron
// npm start
/// Users/cristophercruz/IdeaProjects/World Hello
// /Users/cristophercruz/IdeaProjects/World Hello